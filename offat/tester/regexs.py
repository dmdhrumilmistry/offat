sensitive_data_regex_patterns = {
    ...
    'password': r'\b(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{8,}\b', # Assuming the password contains at least 1 uppercase letter, 1 lowercase letter, 1 digit, 1 special character, and is at least 8 characters long.
    ...
    'us_phone_number':r'\b\d{3}-\d{3}-\d{4}\b',
    ...
    'indian_phone_number': r'/((\+*)((0[ -]*)*|((91 )*))((\d{12})+|(\d{10})+))|\d{5}([- ]*)\d{6}/',
